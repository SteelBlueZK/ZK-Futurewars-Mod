...
local function GenerateModuleWrecks()
	...
	for i = 1, #moduleDefs do
		...
		wreck.metal = moduleDef.cost * 0.5
		wreck.reclaimtime = moduleDef.cost * 0.5
		...
		heap.metal = moduleDef.cost * 0.25
		heap.reclaimtime = moduleDef.cost * 0.25
